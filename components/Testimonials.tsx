  ...
  return (
    <Section className="bg-brand-900 text-white relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <blockquote className="font-serif text-3xl md:text-5xl leading-tight mb-12 font-medium">
        ...
        <div className="flex flex-col items-center">
            <cite className="font-sans font-bold tracking-wide text-lg not-italic">Sarah Jenkins</cite>
